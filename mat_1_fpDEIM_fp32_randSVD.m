    ...
    ylabel(ax1,'$$||A-\hat{C} U \hat{R}||$$', 'Interpreter', 'latex','FontSize',18);
        ...
        title(ax1,'Finite precision DEIM for fp32 randSVD','Interpreter', 'latex','FontSize',18);
    ...
    title(ax2,'$\hat{\eta}_p$ for finite precision DEIM for fp32 randSVD', 'Interpreter', 'latex','FontSize',18);

saveas(f1,'mat_1_fpDEIM_fp32_randSVD','pdf')
saveas(f2,'mat_1_eta_DEIM_fp32_randSVD','pdf')
